...
class B2bMarketplaceScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<B2bMarketplaceScreen> createState() =>
      _B2bMarketplaceScreenState();
}
                ...
                children: [
                  deal.firstImage.isNotEmpty
                      ? Image.network(
                          deal.firstImage,
                          fit: BoxFit.cover,
                          errorBuilder: (_, __, ___) => _imgFallback(colors),
                        )
                      : _imgFallback(colors),
                  Container(
...
class _DealsSkeletonBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(height: 16, width: 120, color: colors.surfaceTertiary),
        const SizedBox(height: 12),
        Container(
          height: 280,
          decoration: BoxDecoration(
        ...
        Container(height: 16, width: 160, color: colors.surfaceTertiary),
        const SizedBox(height: 12),
        SizedBox(
          height: 190,
          child: ListView.separated(
